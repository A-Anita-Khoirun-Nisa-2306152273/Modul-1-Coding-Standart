...
class CreateProductFunctionalTest {
    ...
    void testCreateProductisCorrect(ChromeDriver driver) throws Exception {
        ...
        assertTrue(pageSource.contains("Sampo Harimau"));
        assertTrue(pageSource.contains("70000"));
    }
}